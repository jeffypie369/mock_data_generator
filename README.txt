...
17. Repeat steps 2 to 16 for all other tables, keeping in mind once again where foreign keys are involved, to have these tables created after the reference tables have been created.