...
def float_generator(n, decimals=2, distribution='uniform', min=0, max=10, exclusion=None, unique=False, selectivity=0, mean=0, sd=1):
  """
  n: total count of floats to generate
  decimals: number of digits after decimal point
  distribution: specifies type of distribution that floats generated will be in, either 'uniform', 'normal' or 'poisson'

  UNIFORM DISTRIBUTION ARGS - 'uniform' distribution
  ...
  NORMAL DISTRIBUTION ARGS
  Approach 1 - 'normal' distribution
  mean: mean value of floating point numbers
  sd: standard value of floating point numbers
  Approach 2 - 'normal_minmax' distribution 
  min: min value of list of floats
  max: max value of list of floats
  
  POISSON DISTRIBUTION ARGS - 'poisson' distribution
  mean: mean value of floating point numbers
  """
  ...
  elif distribution == 'normal_minmax':
...
def float_generator_single(decimals=2, distribution='uniform', min=0, max=10, exclusion=None, mean=0, sd=1):
  """
  decimals: number of digits after decimal point
  distribution: specifies type of distribution that float will be generated in, either 'uniform', 'normal' or 'poisson'

  UNIFORM DISTRIBUTION ARGS - 'uniform' distribution
  min: min value of float
  max: max value of float
  exclusion: list of unique values in (min, max) to be excluded from generation
